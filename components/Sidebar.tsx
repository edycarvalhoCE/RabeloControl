...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, isMobileOpen, setIsMobileOpen }) => {
  ...
  const menuItems = [
    ...
    { id: 'bookings', label: 'Listar Locações', icon: '🚌', roles: [UserRole.MANAGER, UserRole.DEVELOPER, UserRole.AGENT] },
    { id: 'clients', label: 'Clientes', icon: '👥', roles: [UserRole.MANAGER, UserRole.FINANCE, UserRole.DEVELOPER, UserRole.AGENT] },
    { id: 'calendar', label: 'Calendário (Escala)', icon: '📅', roles: [UserRole.MANAGER, UserRole.DEVELOPER, UserRole.AGENT] },
    { id: 'travel-packages', label: 'Pacotes de Viagem', icon: '🏖️', roles: [UserRole.MANAGER, UserRole.FINANCE, UserRole.DEVELOPER, UserRole.AGENT] },
  ...
  const getRoleLabel = (role: UserRole | string) => {
    switch (role) {
      ...
      case UserRole.AGENT: return 'Agente Comercial';
